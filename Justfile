export image_name := env("IMAGE_NAME", "bazzite-freeipa") # output image name, usually same as repo name, change as needed
export default_tag := env("DEFAULT_TAG", "latest")
export bib_image := env("BIB_IMAGE", "registry.fedoraproject.org/fedora/bootc-image-builder:latest")
